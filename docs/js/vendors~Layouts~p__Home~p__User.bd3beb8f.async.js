  ...
  [1],
  {
    ...
    XaGS: function (t, e, n) {
      (function (t, n) {
        var r = 200,
          ...
          W = /^(?:0|[1-9]\d*)$/,
          B = {};
        (B[P] = B[k] = B[F] = B[M] = B[D] = B[x] = B[z] = B[C] = B[L] = !0),
          (B[a] = B[s] = B[I] = B[f] = B[R] = B[h] = B[d] = B[p] = B[v] = B[y] = B[m] = B[O] = B[
            j
          ] = B[E] = B[A] = !1);
        var V = 'object' == typeof t && t && t.Object === Object && t,
          K = 'object' == typeof self && self && self.Object === Object && self,
          U = V || K || Function('return this')(),
          H = e && !e.nodeType && e,
        ...
        function Qt() {
          (this.size = 0),
            (this.__data__ = { hash: new Nt(), map: new (At || Ut)(), string: new Nt() });
        }
        function Zt(t) {
        ...
        function pe(t, e, n) {
          var r = e(t);
          return Ne(t) ? r : Z(r, n(t));
        }
        function be(t) {
          return null == t ? (void 0 === t ? T : g) : Ot && Ot in Object(t) ? Ie(t) : xe(t);
        }
        function ve(t) {
          return He(t) && be(t) == a;
        }
        ...
        function ge(t, e, n, r, i, c) {
          ...
          if (b && !d)
            return c || (c = new ce()), u || Ge(t) ? Oe(t, e, n, r, i, c) : je(t, e, f, n, r, i, c);
          if (!(n & o)) {
        ...
        function me(t) {
          if (!Ue(t) || Me(t)) return !1;
          var e = Ve(t) ? vt : q;
          return e.test(ze(t));
        }
        function _e(t) {
          return He(t) && Ke(t.length) && !!B[be(t)];
        }
        function we(t) {
          if (!De(t)) return St(t);
          var e = [];
        ...
        ((Tt && Pe(new Tt(new ArrayBuffer(1))) != R) ||
          (At && Pe(new At()) != v) ||
          (It && Pe(It.resolve()) != _) ||
          (Rt && Pe(new Rt()) != j) ||
          (Pt && Pe(new Pt()) != A)) &&
        ...
        var Le = ve(
            ...
            ? ve
            : function (t) {
                return He(t) && dt.call(t, 'callee') && !_t.call(t, 'callee');
              },
          Ne = Array.isArray;
        function qe(t) {
          return null != t && Ke(t.length) && !Ve(t);
        }
        var We = Et || Xe;
        function Be(t, e) {
          return ye(t, e);
    ...
    'n+Aq': function (t, e, n) {
            ...
            G(t, [
              {
                ...
                value: function () {
                  ...
                  (this.state = V({}, this.state, {}, t)), this.subscribe(this.state);
                },
              },
              {
                key: '_run',
      ...
      function X(t, e) {
        ...
        var Z = Object(r['useCallback'])(
          function () {
            ...
            if (W) {
              ...
              z.current = void 0 === e ? $ : e;
            }
            var n = z.current,
              r = Q.current[n];
            if (!r) {
              var i = new Y(C, K, U.bind(null, n), { data: x });
              (r = i.state),
                J(function (t) {
                  return (t[n] = r), V({}, t);
                });
        ...
        Object(r['useEffect'])(
          function () {
            k && d(k, { fetches: X, newstFetchKey: z.current });
          },
          [k, X],
        ),
          Object(r['useEffect'])(function () {
            a ||
              (Object.keys(X).length > 0
                ? Object.values(X).forEach(function (t) {
                    t.refresh();
                  })
                : Z.apply(void 0, L(S)));
          }, []);
        var tt = Object(r['useCallback'])(
          function () {
            Object.values(Q.current).forEach(function (t) {
              t.unmount();
            }),
              (z.current = $),
              J({}),
        ...
        var p = J(
          ...
          w = Object(r['useCallback'])(
            function () {
              ...
              var t = et(y),
                e = t.slice(1);
              v.apply(void 0, [void 0].concat(Q(e)));
            },
            [v, g, y],
          ),
          O = Object(r['useRef'])(w);
      ...
      function Tt(t, e) {
        ...
        var s = J(t, Ot({ defaultParams: [{ current: 1, pageSize: i }] }, a)),
          l = s.data,
          f = s.params,
          h = s.run,
          d = s.loading,
      ...
      function zt(t) {
        ...
        return u ? dt(f, i) : c ? At(f, i) : J(f, i);
      }
      Rt.Provider;
      var Ct = zt;
      n('XaGS');
